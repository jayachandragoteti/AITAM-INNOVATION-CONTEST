...
if (isset($_POST['finish'])) {
    ...
    if ($topics !='' && $class !='' && $admno !='' && $schoolname !='' && $district !='' && $address !='' && $alternatenumber !='' && $_FILES["file"]["name"] !='' && $firstname !='' && $surname !='' ) {
            ...
            else 
            {
                ...
                {
                    $sql = "INSERT INTO `cat1_register` (`firstname`, `surname`, `phonenumber`, `alternatenumber`, `address`, `district`, `schoolname`, `admno`, `class`, `topics`, `uploadPDF`)VALUES ('$firstname','$surname','$phonenumber','$alternatenumber','$address','$district','$schoolname','$admno','$class','$topics','$modefide_file_name')";
